  ...
  while not file_saved:
    ...
    if not file_saved:
      ...
      if reset_flag and not file_saved:
        ...
        # Save to local path
        output_dir = Path('/home/rx03116/GithubItems/mjlab/motions')
...
def main(
  ...
  scene_cfg = SceneCfg(
      ...
      num_envs=1,
      entities={"robot": get_rlboy_robot_cfg()},
  )
  ...
  run_sim(
    ...
    joint_names=[
      ...
      "waist_yaw_joint",
      "head_yaw_joint",
      # Left arm: shoulder_pitch, shoulder_roll, shoulder_yaw, elbow_pitch
